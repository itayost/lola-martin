  ...
  return (
    <div className="">
      ...
      <HalfPillRow
        ...
        title="מה בתפריט"
        text="בלולה מרטין מוצג תפריט עשיר ומגוון שמביא את מגוון פירות הים לקדמת הבמה, קוקי סאן ז׳אק, אוייסטרים, שרימפס, תפריט סושי ייחודי ועוד לצד מנות דגים מגוונות."
