...
const WelcomeSection = () => {
  ...
  return (
    <Section ref={sectionRef} className="relative bg-card text-text py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <m.div ref={contentRef} style={{ opacity, y }} className="relative max-w-2xl mx-auto">
          ...
          <m.div className="space-y-6 text-right" style={{ opacity: textOpacity, y: textY }}>
            <p className="text-lightMuted">
              בלב הרצליה פיתוח שוכנת מסעדת לולה מרטין בהובלת המסעדן אפי אללוף. לולה מרטין היא מקדש
              לדגים ופירות ים הכולל בר - מסעדה עם מנות מגוונות אשר תקנה לכם חווית דגים ייחודית
              ואוטנטית.
            </p>

            <p className="text-lightMuted">
              אפי אללוף המייסד, הבעלים ומי שאחראי על הצד הקולינרי (ג׳קו מאכלי ים) מביא אליכם להרצליה
              מסורת מפוארת של ידע, אהבה לדגים ופירות ים לצד חדשנות בעולם הקולינרי בארץ.
            </p>

            <p className="text-lightMuted">
              בלולה מרטין תמצאו תפריט עשיר ומגוון שמביא את מגוון פירות הים לקדמת הבמה, קוקי סאן
              ז׳אק, אוייסטרים, שרימפס, תפריט סושי ייחודי ועוד לצד מנות דגים מגוונות, דגים נעים
              וספיישלים מהדגה הימית הטרייה.
            </p>

            <p className="text-lightMuted">
              לולה מרטין מעוצבת כולה מתוך אהבה לים, בצבעים של מעמקי האוקיינוס, על קירות המסעדה תוכלו
              לראות תמונות ענק של ייצורי ים. במרכז המסעדה בר ישיבה אינטימי ומפנק בו תוכלו לקבל יחס
              אישי וממנו ייצאו קוקטיילים מושקעים ואיכותיים, מגוון של אלכוהול והרבה הרבה יין.
            </p>

            <p className="text-lightMuted">
              במסעדה תפגשו צוות משפחתי ומקצועי אשר יקבל אתכם עם חיוך רחב, ויוכל להתאים לכם את החוויה
              המושלמת.
            </p>
          </m.div>
          ...
          >
            ...
            >
              <Button href={info.reservations.url} className="px-6 py-2">
                להזמנת מקום
              </Button>
            </m.div>
          </m.div>
